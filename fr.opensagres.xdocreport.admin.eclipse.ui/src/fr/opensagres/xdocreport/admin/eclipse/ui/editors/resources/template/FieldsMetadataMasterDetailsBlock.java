...
public class FieldsMetadataMasterDetailsBlock extends
	...
	protected void onCreateUI(final IManagedForm managedForm, Composite parent) {
		...
		Section section = toolkit.createSection(parent, Section.DESCRIPTION
				| Section.TITLE_BAR);
		section.setText(Messages.TemplateResourceEditor_FieldsMetadataPage_FieldsMetadataMasterDetailsBlock_title); //$NON-NLS-1$
		section.setDescription(Messages.TemplateResourceEditor_FieldsMetadataPage_FieldsMetadataMasterDetailsBlock_desc); //$NON-NLS-1$
		...
		Tree fieldsTree = toolkit.createTree(client, SWT.MULTI);
		...
		viewer = new TreeViewer(fieldsTree);
